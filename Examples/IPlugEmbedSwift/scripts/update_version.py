...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugEmbedSwift-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugEmbedSwift-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/IPlugEmbedSwift-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/IPlugEmbedSwift-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/IPlugEmbedSwift-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/IPlugEmbedSwift.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugEmbedSwift.iss",inplace=1):
