...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugEmbedSwift Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugEmbedSwift Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugEmbedSwift Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugEmbedSwift installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugEmbedSwift Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugEmbedSwift installer\n"
